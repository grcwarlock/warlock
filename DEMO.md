...
- **Warlock** — migrations, seed data (81 connectors, 5,007 findings, 373,852 control results), API server
...
4. Seeds 81 connectors, 5,007 findings, 373,852 control results across 14 frameworks
