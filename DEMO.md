...
2. Starts the OPA server with 634 Rego policies (if OPA is installed)
...
With OPA installed, the demo evaluates 634 Rego policies across 7 frameworks (NIST 800-53, ISO 27001, SOC 2, CMMC, HIPAA, UCF, Terraform). Without OPA, the demo still works — it just skips policy evaluation.
