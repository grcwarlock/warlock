...
Warlock includes 350 source connectors that collect security and compliance telemetry from the tools your organization already uses. Each connector follows the same contract: validate configuration, verify connectivity, and produce raw events with verbatim API responses preserved for auditability.
