...
class AzureConnector(BaseConnector):
    ...
    def validate(self) -> list[str]:
        ...
        try:
            ...
            errors.append(
                "azure-identity not installed. Install with: pip install warlock[azure]"
            )
    ...
    def health_check(self) -> bool:
        try:
            ...
            client = ResourceManagementClient(
                credential, self.config.settings["subscription_id"]
            )
    ...
    def _collect_policy_compliance(
        self, credential, subscription_id: str, tenant_id: str
    ) -> dict:
