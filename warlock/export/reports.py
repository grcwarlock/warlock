    ...
    def generate_html(
        ...
        *,
        ...
        Args:
            ...
            framework: Framework identifier.
            engagement_id: Optional engagement to scope by period.
            organization: Organization name for the cover page.
            for_pdf: When True, includes @page CSS rules, cover page, and TOC
        ...
        # Build cover page HTML (only for PDF)
        cover_html = ""
        if for_pdf:
            cover_html = f"""
<div class="cover-page">
  <div class="cover-content">
    <div class="cover-org">{_html.escape(organization)}</div>
    <h1 class="cover-title">{_html.escape(framework)} Compliance Report</h1>
    <div class="cover-date">{date_str}</div>
    <div class="cover-meta">Generated by Warlock GRC Platform</div>
  </div>
</div>
"""
  ...
  @page {
    ...
    @top-center {
      content: """
                + f'"{_html.escape(framework)} Compliance Report"'
                + """;
      font-size: 8pt;
      color: #888;
    }
...
<title>{_html.escape(framework)} Compliance Report</title>
<style>
  {page_css}
  @media print {{
    body {{ font-size: 11pt; }}
...
{html_body}
<footer>
  Generated by Warlock GRC Platform | {now_str}
</footer>
</body>
</html>"""
    ...
    def generate_pdf(
        ...
        *,
        ...
        Produces a production-ready PDF with cover page, table of contents,
        page numbers in the footer, and consistent margins via @page rules.
        Attempts to use weasyprint for high-quality PDF generation.
        Falls back with a helpful error if weasyprint is not installed.

        Args:
            session: SQLAlchemy session.
            framework: Framework identifier.
            engagement_id: Optional engagement to scope by period.
            organization: Organization name for the cover page and footer.
        ...
        raise ImportError(
            ...
            "Install it with: pip install 'warlock[pdf]'\n"
