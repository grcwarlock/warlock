...
_CONNECTOR_MODULES = [
    ...
    # --- Expansion connectors (186) ---
    "warlock.connectors.heroku",
    "warlock.connectors.scaleway",
    "warlock.connectors.render",
    "warlock.connectors.netlify",
    "warlock.connectors.vercel_cloud",
    "warlock.connectors.mongodb_atlas",
    "warlock.connectors.supabase",
    "warlock.connectors.snowflake",
    "warlock.connectors.aws_govcloud",
    "warlock.connectors.aws_inspector",
    "warlock.connectors.akamai",
    "warlock.connectors.imperva",
    "warlock.connectors.ping_identity_new",
    "warlock.connectors.lastpass",
    "warlock.connectors.dashlane",
    "warlock.connectors.nordpass",
    "warlock.connectors.keeper",
    "warlock.connectors.accessowl",
    "warlock.connectors.indent",
    "warlock.connectors.saviynt",
    "warlock.connectors.conductorone",
    "warlock.connectors.boundary",
    "warlock.connectors.teleport",
    "warlock.connectors.strongdm",
    "warlock.connectors.doppler",
    "warlock.connectors.infisical",
    "warlock.connectors.bitbucket",
    "warlock.connectors.aws_codecommit",
    "warlock.connectors.azure_repos",
    "warlock.connectors.azure_devops",
    "warlock.connectors.argocd",
    "warlock.connectors.harness",
    "warlock.connectors.buildkite",
    "warlock.connectors.launchdarkly",
    "warlock.connectors.fivetran",
    "warlock.connectors.dbt_labs",
    "warlock.connectors.asana",
    "warlock.connectors.linear",
    "warlock.connectors.clickup",
    "warlock.connectors.trello",
    "warlock.connectors.monday",
    "warlock.connectors.shortcut",
    "warlock.connectors.notion",
    "warlock.connectors.smartsheet",
    "warlock.connectors.wrike",
    "warlock.connectors.basecamp",
    "warlock.connectors.height",
    "warlock.connectors.freshservice",
    "warlock.connectors.freshdesk",
    "warlock.connectors.zendesk",
    "warlock.connectors.zoho_desk",
    "warlock.connectors.hibob",
    "warlock.connectors.justworks",
    "warlock.connectors.lattice",
    "warlock.connectors.trinet",
    "warlock.connectors.dayforce",
    "warlock.connectors.oracle_hcm",
    "warlock.connectors.personio",
    "warlock.connectors.deel",
    "warlock.connectors.namely",
    "warlock.connectors.paychex_flex",
    "warlock.connectors.humaans",
    "warlock.connectors.xero_payroll",
    "warlock.connectors.fifteenfive",
    "warlock.connectors.leapsome",
    "warlock.connectors.hr_cloud",
    "warlock.connectors.isolved",
    "warlock.connectors.kenjo",
    "warlock.connectors.employment_hero",
    "warlock.connectors.zoho_people",
    "warlock.connectors.greenhouse",
    "warlock.connectors.lever",
    "warlock.connectors.ashby",
    "warlock.connectors.smartrecruiters",
    "warlock.connectors.teamtailor",
    "warlock.connectors.workable",
    "warlock.connectors.checkr",
    "warlock.connectors.certn",
    "warlock.connectors.hireright",
    "warlock.connectors.sterling",
    "warlock.connectors.three60learning",
    "warlock.connectors.cornerstone",
    "warlock.connectors.coursera",
    "warlock.connectors.easyllama",
    "warlock.connectors.infosec_iq",
    "warlock.connectors.linkedin_learning",
    "warlock.connectors.talentlms",
    "warlock.connectors.udemy",
    "warlock.connectors.docebo",
    "warlock.connectors.go1",
    "warlock.connectors.sosafe",
    "warlock.connectors.moxso",
    "warlock.connectors.awarego",
    "warlock.connectors.cybeready",
    "warlock.connectors.hexnode",
    "warlock.connectors.ninjaone",
    "warlock.connectors.kolide",
    "warlock.connectors.addigy",
    "warlock.connectors.miradore",
    "warlock.connectors.aikido",
    "warlock.connectors.sonarcloud",
    "warlock.connectors.wiz_code",
    "warlock.connectors.huntress",
    "warlock.connectors.jit_security",
    "warlock.connectors.upwind",
    "warlock.connectors.arnica",
    "warlock.connectors.pentera",
    "warlock.connectors.horizon3",
    "warlock.connectors.bugcrowd",
    "warlock.connectors.intigriti",
    "warlock.connectors.halo_security",
    "warlock.connectors.traceable_ai",
    "warlock.connectors.sentry",
    "warlock.connectors.rollbar",
    "warlock.connectors.dynatrace",
    "warlock.connectors.sumo_logic_new",
    "warlock.connectors.hubspot",
    "warlock.connectors.pipedrive",
    "warlock.connectors.intercom",
    "warlock.connectors.gong",
    "warlock.connectors.freshsales",
    "warlock.connectors.attio",
    "warlock.connectors.copper",
    "warlock.connectors.close_crm",
    "warlock.connectors.microsoft_teams",
    "warlock.connectors.miro",
    "warlock.connectors.webex",
    "warlock.connectors.ringcentral",
    "warlock.connectors.aircall",
    "warlock.connectors.dialpad",
    "warlock.connectors.eight_x_eight",
    "warlock.connectors.twilio",
    "warlock.connectors.box",
    "warlock.connectors.dropbox",
    "warlock.connectors.google_drive",
    "warlock.connectors.egnyte",
    "warlock.connectors.ramp",
    "warlock.connectors.brex",
    "warlock.connectors.netsuite",
    "warlock.connectors.vendr",
    "warlock.connectors.docusign",
    "warlock.connectors.ironclad",
    "warlock.connectors.dropbox_sign",
    "warlock.connectors.segment",
    "warlock.connectors.mixpanel",
    "warlock.connectors.tableau",
    "warlock.connectors.domo",
    "warlock.connectors.qlik",
    "warlock.connectors.sigma_computing",
    "warlock.connectors.transcend",
    "warlock.connectors.ketch",
    "warlock.connectors.openai_platform",
    "warlock.connectors.anthropic_platform",
    "warlock.connectors.aws_bedrock",
    "warlock.connectors.credo_ai",
    "warlock.connectors.arthur_ai",
    "warlock.connectors.fiddler_ai",
    "warlock.connectors.appomni",
    "warlock.connectors.obsidian_security",
    "warlock.connectors.nudge_security",
    "warlock.connectors.rootly",
    "warlock.connectors.incident_io",
    "warlock.connectors.firehydrant",
    "warlock.connectors.snipe_it",
    "warlock.connectors.oomnitza",
    "warlock.connectors.servicenow_itam",
    "warlock.connectors.monte_carlo",
    "warlock.connectors.bigeye",
    "warlock.connectors.vantage_finops",
    "warlock.connectors.cloudhealth",
    "warlock.connectors.spot_netapp",
    "warlock.connectors.zentry",
    "warlock.connectors.openvpn",
    "warlock.connectors.teamviewer",
    "warlock.connectors.cyral",
    "warlock.connectors.immuta",
    "warlock.connectors.sprinto",
    "warlock.connectors.thoropass",
    "warlock.connectors.backstage",
    "warlock.connectors.retool",
    "warlock.connectors.sendgrid",
    "warlock.connectors.envoy",
    "warlock.connectors.canva",
    "warlock.connectors.jetbrains",
    "warlock.connectors.webflow",
    "warlock.connectors.contentful",
]
...
_NORMALIZER_MODULES = [
    ...
    "warlock.normalizers.heroku",
    "warlock.normalizers.scaleway",
    "warlock.normalizers.render",
    "warlock.normalizers.netlify",
    "warlock.normalizers.vercel_cloud",
    "warlock.normalizers.mongodb_atlas",
    "warlock.normalizers.supabase",
    "warlock.normalizers.snowflake",
    "warlock.normalizers.aws_govcloud",
    "warlock.normalizers.aws_inspector",
    "warlock.normalizers.akamai",
    "warlock.normalizers.imperva",
    "warlock.normalizers.ping_identity_new",
    "warlock.normalizers.lastpass",
    "warlock.normalizers.dashlane",
    "warlock.normalizers.nordpass",
    "warlock.normalizers.keeper",
    "warlock.normalizers.accessowl",
    "warlock.normalizers.indent",
    "warlock.normalizers.saviynt",
    "warlock.normalizers.conductorone",
    "warlock.normalizers.boundary",
    "warlock.normalizers.teleport",
    "warlock.normalizers.strongdm",
    "warlock.normalizers.doppler",
    "warlock.normalizers.infisical",
    "warlock.normalizers.bitbucket",
    "warlock.normalizers.aws_codecommit",
    "warlock.normalizers.azure_repos",
    "warlock.normalizers.azure_devops",
    "warlock.normalizers.argocd",
    "warlock.normalizers.harness",
    "warlock.normalizers.buildkite",
    "warlock.normalizers.launchdarkly",
    "warlock.normalizers.fivetran",
    "warlock.normalizers.dbt_labs",
    "warlock.normalizers.asana",
    "warlock.normalizers.linear",
    "warlock.normalizers.clickup",
    "warlock.normalizers.trello",
    "warlock.normalizers.monday",
    "warlock.normalizers.shortcut",
    "warlock.normalizers.notion",
    "warlock.normalizers.smartsheet",
    "warlock.normalizers.wrike",
    "warlock.normalizers.basecamp",
    "warlock.normalizers.height",
    "warlock.normalizers.freshservice",
    "warlock.normalizers.freshdesk",
    "warlock.normalizers.zendesk",
    "warlock.normalizers.zoho_desk",
    "warlock.normalizers.hibob",
    "warlock.normalizers.justworks",
    "warlock.normalizers.lattice",
    "warlock.normalizers.trinet",
    "warlock.normalizers.dayforce",
    "warlock.normalizers.oracle_hcm",
    "warlock.normalizers.personio",
    "warlock.normalizers.deel",
    "warlock.normalizers.namely",
    "warlock.normalizers.paychex_flex",
    "warlock.normalizers.humaans",
    "warlock.normalizers.xero_payroll",
    "warlock.normalizers.fifteenfive",
    "warlock.normalizers.leapsome",
    "warlock.normalizers.hr_cloud",
    "warlock.normalizers.isolved",
    "warlock.normalizers.kenjo",
    "warlock.normalizers.employment_hero",
    "warlock.normalizers.zoho_people",
    "warlock.normalizers.greenhouse",
    "warlock.normalizers.lever",
    "warlock.normalizers.ashby",
    "warlock.normalizers.smartrecruiters",
    "warlock.normalizers.teamtailor",
    "warlock.normalizers.workable",
    "warlock.normalizers.checkr",
    "warlock.normalizers.certn",
    "warlock.normalizers.hireright",
    "warlock.normalizers.sterling",
    "warlock.normalizers.three60learning",
    "warlock.normalizers.cornerstone",
    "warlock.normalizers.coursera",
    "warlock.normalizers.easyllama",
    "warlock.normalizers.infosec_iq",
    "warlock.normalizers.linkedin_learning",
    "warlock.normalizers.talentlms",
    "warlock.normalizers.udemy",
    "warlock.normalizers.docebo",
    "warlock.normalizers.go1",
    "warlock.normalizers.sosafe",
    "warlock.normalizers.moxso",
    "warlock.normalizers.awarego",
    "warlock.normalizers.cybeready",
    "warlock.normalizers.hexnode",
    "warlock.normalizers.ninjaone",
    "warlock.normalizers.kolide",
    "warlock.normalizers.addigy",
    "warlock.normalizers.miradore",
    "warlock.normalizers.aikido",
    "warlock.normalizers.sonarcloud",
    "warlock.normalizers.wiz_code",
    "warlock.normalizers.huntress",
    "warlock.normalizers.jit_security",
    "warlock.normalizers.upwind",
    "warlock.normalizers.arnica",
    "warlock.normalizers.pentera",
    "warlock.normalizers.horizon3",
    "warlock.normalizers.bugcrowd",
    "warlock.normalizers.intigriti",
    "warlock.normalizers.halo_security",
    "warlock.normalizers.traceable_ai",
    "warlock.normalizers.sentry",
    "warlock.normalizers.rollbar",
    "warlock.normalizers.dynatrace",
    "warlock.normalizers.sumo_logic_new",
    "warlock.normalizers.hubspot",
    "warlock.normalizers.pipedrive",
    "warlock.normalizers.intercom",
    "warlock.normalizers.gong",
    "warlock.normalizers.freshsales",
    "warlock.normalizers.attio",
    "warlock.normalizers.copper",
    "warlock.normalizers.close_crm",
    "warlock.normalizers.microsoft_teams",
    "warlock.normalizers.miro",
    "warlock.normalizers.webex",
    "warlock.normalizers.ringcentral",
    "warlock.normalizers.aircall",
    "warlock.normalizers.dialpad",
    "warlock.normalizers.eight_x_eight",
    "warlock.normalizers.twilio",
    "warlock.normalizers.box",
    "warlock.normalizers.dropbox",
    "warlock.normalizers.google_drive",
    "warlock.normalizers.egnyte",
    "warlock.normalizers.ramp",
    "warlock.normalizers.brex",
    "warlock.normalizers.netsuite",
    "warlock.normalizers.vendr",
    "warlock.normalizers.docusign",
    "warlock.normalizers.ironclad",
    "warlock.normalizers.dropbox_sign",
    "warlock.normalizers.segment",
    "warlock.normalizers.mixpanel",
    "warlock.normalizers.tableau",
    "warlock.normalizers.domo",
    "warlock.normalizers.qlik",
    "warlock.normalizers.sigma_computing",
    "warlock.normalizers.transcend",
    "warlock.normalizers.ketch",
    "warlock.normalizers.openai_platform",
    "warlock.normalizers.anthropic_platform",
    "warlock.normalizers.aws_bedrock",
    "warlock.normalizers.credo_ai",
    "warlock.normalizers.arthur_ai",
    "warlock.normalizers.fiddler_ai",
    "warlock.normalizers.appomni",
    "warlock.normalizers.obsidian_security",
    "warlock.normalizers.nudge_security",
    "warlock.normalizers.rootly",
    "warlock.normalizers.incident_io",
    "warlock.normalizers.firehydrant",
    "warlock.normalizers.snipe_it",
    "warlock.normalizers.oomnitza",
    "warlock.normalizers.servicenow_itam",
    "warlock.normalizers.monte_carlo",
    "warlock.normalizers.bigeye",
    "warlock.normalizers.vantage_finops",
    "warlock.normalizers.cloudhealth",
    "warlock.normalizers.spot_netapp",
    "warlock.normalizers.zentry",
    "warlock.normalizers.openvpn",
    "warlock.normalizers.teamviewer",
    "warlock.normalizers.cyral",
    "warlock.normalizers.immuta",
    "warlock.normalizers.sprinto",
    "warlock.normalizers.thoropass",
    "warlock.normalizers.backstage",
    "warlock.normalizers.retool",
    "warlock.normalizers.sendgrid",
    "warlock.normalizers.envoy",
    "warlock.normalizers.canva",
    "warlock.normalizers.jetbrains",
    "warlock.normalizers.webflow",
    "warlock.normalizers.contentful",
]
