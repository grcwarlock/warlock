...
def upgrade() -> None:
    ...
    with op.batch_alter_table(
        "raw_events", schema=None, naming_convention={"fk": "fk_%(table_name)s_%(column_0_name)s"}
    ) as batch_op:
        batch_op.drop_constraint("fk_raw_events_connector_run_id", type_="foreignkey")
        batch_op.create_foreign_key(
            "fk_raw_events_connector_run_id",
            "connector_runs",
            ["connector_run_id"],
            ["id"],
            ondelete="CASCADE",
    ...
    with op.batch_alter_table(
        "findings", schema=None, naming_convention={"fk": "fk_%(table_name)s_%(column_0_name)s"}
    ) as batch_op:
        batch_op.drop_constraint("fk_findings_raw_event_id", type_="foreignkey")
        batch_op.create_foreign_key(
            "fk_findings_raw_event_id", "raw_events", ["raw_event_id"], ["id"], ondelete="CASCADE"
        )
    ...
    with op.batch_alter_table(
        ...
        batch_op.create_foreign_key(
            "fk_control_mappings_finding_id", "findings", ["finding_id"], ["id"], ondelete="CASCADE"
        )
    ...
    with op.batch_alter_table(
        ...
        batch_op.create_foreign_key(
            "fk_control_results_finding_id", "findings", ["finding_id"], ["id"], ondelete="CASCADE"
        )
        batch_op.drop_constraint("fk_control_results_control_mapping_id", type_="foreignkey")
        batch_op.create_foreign_key(
            "fk_control_results_control_mapping_id",
            "control_mappings",
            ["control_mapping_id"],
            ["id"],
            ondelete="CASCADE",
    ...
    with op.batch_alter_table(
        ...
        batch_op.create_foreign_key(
            "fk_issue_comments_issue_id", "issues", ["issue_id"], ["id"], ondelete="CASCADE"
        )

    # 7. issues: poam_id -> SET NULL
    with op.batch_alter_table(
        "issues", schema=None, naming_convention={"fk": "fk_%(table_name)s_%(column_0_name)s"}
    ) as batch_op:
        batch_op.drop_constraint("fk_issues_poam_id", type_="foreignkey")
        batch_op.create_foreign_key(
            "fk_issues_poam_id", "poams", ["poam_id"], ["id"], ondelete="SET NULL"
        )
...
def downgrade() -> None:
    ...
    with op.batch_alter_table("raw_events", schema=None) as batch_op:
        batch_op.drop_constraint("fk_raw_events_connector_run_id", type_="foreignkey")
        batch_op.create_foreign_key(
            "fk_raw_events_connector_run_id", "connector_runs", ["connector_run_id"], ["id"]
        )

    with op.batch_alter_table("findings", schema=None) as batch_op:
        batch_op.drop_constraint("fk_findings_raw_event_id", type_="foreignkey")
        batch_op.create_foreign_key(
            "fk_findings_raw_event_id", "raw_events", ["raw_event_id"], ["id"]
        )
        batch_op.drop_constraint("fk_findings_system", type_="foreignkey")
        batch_op.create_foreign_key(
            "fk_findings_system", "system_profiles", ["system_profile_id"], ["id"]
        )

    with op.batch_alter_table("control_mappings", schema=None) as batch_op:
        batch_op.drop_constraint("fk_control_mappings_finding_id", type_="foreignkey")
        batch_op.create_foreign_key(
            "fk_control_mappings_finding_id", "findings", ["finding_id"], ["id"]
        )

    with op.batch_alter_table("control_results", schema=None) as batch_op:
        batch_op.drop_constraint("fk_control_results_finding_id", type_="foreignkey")
        batch_op.create_foreign_key(
            "fk_control_results_finding_id", "findings", ["finding_id"], ["id"]
        )
        batch_op.drop_constraint("fk_control_results_control_mapping_id", type_="foreignkey")
        batch_op.create_foreign_key(
            "fk_control_results_control_mapping_id",
        ...
        batch_op.drop_constraint("fk_control_results_system", type_="foreignkey")
        batch_op.create_foreign_key(
            "fk_control_results_system", "system_profiles", ["system_profile_id"], ["id"]
        )

    with op.batch_alter_table("issue_comments", schema=None) as batch_op:
        batch_op.drop_constraint("fk_issue_comments_issue_id", type_="foreignkey")
        batch_op.create_foreign_key("fk_issue_comments_issue_id", "issues", ["issue_id"], ["id"])
