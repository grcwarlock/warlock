...
def upgrade() -> None:
    ...
    with op.batch_alter_table('posture_snapshots', schema=None) as batch_op:
        ...
        batch_op.drop_constraint('fk_posture_system_profile', type_='foreignkey') \
            if _fk_exists('posture_snapshots', 'fk_posture_system_profile') else None
    ...
    with op.batch_alter_table('legal_holds', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('date_range_start', sa.DateTime(timezone=True), nullable=True))
