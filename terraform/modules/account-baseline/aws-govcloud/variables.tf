...
variable "enable_guardduty" {
  description = "Enable GuardDuty threat detection (limited availability in GovCloud)"
  type        = bool
  default     = true
}

variable "enable_security_hub" {
  description = "Enable Security Hub centralized findings (limited standards in GovCloud)"
  type        = bool
  default     = true
}
