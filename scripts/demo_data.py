...
FIRST_NAMES = [
    "Alice", "Bob", "Carlos", "Diana", "Elena", "Faisal", "Grace", "Hassan",
    "Ingrid", "James", "Karen", "Liam", "Mei", "Noah", "Olivia", "Priya",
    "Quinn", "Raj", "Sofia", "Tomas", "Uma", "Victor", "Wendy", "Xavier",
    "Yuki", "Zara", "Aaron", "Beth", "Chen", "David", "Emily", "Frank",
    "Gita", "Henry", "Isla", "Juan", "Kate", "Leo", "Maria", "Nadia",
    "Oscar", "Paula", "Ravi", "Sarah", "Tyler", "Vera", "Will", "Xena",
    "Yolanda", "Zach", "Aisha", "Brian", "Carmen", "Derek", "Eva", "Felix",
    "Hannah", "Ian", "Julia", "Kevin", "Luna", "Mike", "Nina", "Owen",
    "Petra", "Ryan", "Sana", "Tariq", "Ursula", "Vikram", "Zoe",
]

LAST_NAMES = [
    "Chen", "Martinez", "Johnson", "Patel", "Williams", "Kim", "O'Brien",
    "Garcia", "Nakamura", "Singh", "Anderson", "Kowalski", "Ali", "Thompson",
    "Rodriguez", "Lee", "Johansson", "Gupta", "Mueller", "Santos",
    "Hernandez", "Yamamoto", "Brown", "Ivanova", "Costa", "Park", "Wilson",
    "Khan", "Larsson", "Okafor", "Taylor", "Zhao", "Davis", "Schmidt",
    "Clark", "Reyes", "Mitchell", "Turner", "Wright", "Lopez", "Hill",
    "Green", "Adams", "Baker", "Nelson", "Carter", "Phillips", "Evans",
    "Torres", "Collins",
]
...
_TITLES = {
    ...
    "IT": [
        "IT Administrator", "Systems Engineer", "IT Manager",
        "Help Desk Analyst", "Network Engineer",
    ],
    "Finance": [
        "Financial Analyst", "Controller", "CFO", "Accounts Payable Specialist",
        "FP&A Manager",
    ],
    "Legal": [
        "General Counsel", "Corporate Attorney", "Paralegal",
        "Privacy Counsel", "Compliance Officer",
    ],
    "HR": [
        "HR Manager", "Recruiter", "HR Business Partner",
        "People Operations Lead", "Benefits Coordinator",
    ],
    "Sales": [
        "Account Executive", "Sales Manager", "SDR", "VP Sales",
        "Solutions Engineer",
    ],
    "Marketing": [
        "Marketing Manager", "Content Strategist", "Growth Lead",
        "Product Marketing Manager", "Brand Designer",
    ],
    "Product": [
    ...
    "Support": [
        ...
        "Technical Account Manager", "Support Lead",
    ],
}

_LOCATIONS = [
    ("San Francisco", "US"), ("New York", "US"), ("Austin", "US"),
    ("Seattle", "US"), ("Denver", "US"), ("Chicago", "US"),
    ("London", "GB"), ("Berlin", "DE"), ("Dublin", "IE"),
    ("Toronto", "CA"), ("Bangalore", "IN"), ("Singapore", "SG"),
    ("Sydney", "AU"), ("Tokyo", "JP"), ("Sao Paulo", "BR"),
]
...
_INSTANCE_TYPES = {
    "aws": ["t3.micro", "t3.medium", "t3.large", "m6i.xlarge", "m6i.2xlarge",
             "c6i.xlarge", "r6i.xlarge", "r6i.2xlarge", "m7g.medium", "c7g.large"],
    "azure": ["Standard_B2s", "Standard_D2s_v5", "Standard_D4s_v5",
               "Standard_E2s_v5", "Standard_F4s_v2"],
    "gcp": ["e2-micro", "e2-medium", "e2-standard-2", "e2-standard-4",
...
_VPC_IDS = [
    "vpc-0a1b2c3d4e5f6a7b8", "vpc-1b2c3d4e5f6a7b8c9",
    "vpc-2c3d4e5f6a7b8c9d0", "vpc-3d4e5f6a7b8c9d0e1",
]

_VULN_TITLES = [
    ("Remote Code Execution in OpenSSL", "critical", 9.8, "openssl", "3.1.3", "3.1.4"),
    ("SQL Injection in PostgreSQL JDBC Driver", "critical", 9.1, "postgresql-jdbc", "42.6.0", "42.6.1"),
...
_VENDOR_NAMES = [
    ("Stripe", "payment_processing"), ("Datadog", "observability"),
    ("Snowflake", "data_warehouse"), ("Salesforce", "crm"),
    ("Zendesk", "support"), ("Twilio", "communications"),
    ("SendGrid", "email"), ("PagerDuty", "incident_management"),
    ("LaunchDarkly", "feature_flags"), ("Segment", "analytics"),
    ("Auth0", "identity"), ("MongoDB Atlas", "database"),
    ("Cloudflare", "cdn_security"), ("GitHub", "source_control"),
    ("Slack", "collaboration"), ("Notion", "documentation"),
    ("Figma", "design"), ("Linear", "project_management"),
    ("Vercel", "hosting"), ("AWS", "cloud_infrastructure"),
    ("GCP", "cloud_infrastructure"), ("Azure", "cloud_infrastructure"),
    ("DocuSign", "document_signing"), ("Greenhouse", "recruiting"),
    ("BambooHR", "hris"), ("Netsuite", "erp"),
    ("Expensify", "expense_management"), ("Brex", "corporate_card"),
    ("Vanta", "compliance"), ("Drata", "compliance"),
    ("CrowdStrike", "endpoint_security"), ("SentinelOne", "endpoint_security"),
    ("Snyk", "application_security"), ("Wiz", "cloud_security"),
    ("Zscaler", "network_security"), ("Proofpoint", "email_security"),
    ("KnowBe4", "security_training"), ("1Password", "password_management"),
    ("HashiCorp Vault", "secrets_management"), ("Terraform Cloud", "infrastructure_as_code"),
]
...
_SUSPICIOUS_DOMAINS = [
    "malware-c2-server.xyz", "phish-acme-login.com", "data-exfil-drop.net",
    "cryptominer-pool.ru", "evil-redirect.info",
]

_REPOS = [
    "acme/api-gateway", "acme/web-app", "acme/mobile-ios", "acme/mobile-android",
    "acme/billing-service", "acme/auth-service", "acme/data-pipeline",
    "acme/ml-platform", "acme/infrastructure", "acme/docs",
    "acme/notification-service", "acme/search-service", "acme/admin-dashboard",
    "acme/sdk-python", "acme/sdk-node",
]

_LANGUAGES = ["python", "typescript", "go", "java", "rust", "javascript", "kotlin", "swift"]

_BASE_IMAGES = [
    "python:3.12-slim", "node:20-alpine", "golang:1.22-bookworm",
    "eclipse-temurin:21-jre-alpine", "rust:1.77-slim", "nginx:1.25-alpine",
    "redis:7-alpine", "postgres:16-alpine", "ubuntu:24.04",
]

_CONTAINER_REPOS = [
    "acme/api-gateway", "acme/web-frontend", "acme/billing-service",
    "acme/auth-service", "acme/data-pipeline", "acme/ml-worker",
    "acme/notification-service", "acme/search-service", "acme/admin-dashboard",
    "acme/cron-scheduler",
]

_IAC_RESOURCE_TYPES = [
    "aws_s3_bucket", "aws_security_group", "aws_iam_role", "aws_iam_policy",
    "aws_rds_instance", "aws_lambda_function", "aws_cloudwatch_log_group",
    "azurerm_storage_account", "azurerm_network_security_group",
    "azurerm_key_vault", "google_compute_instance", "google_storage_bucket",
    "google_project_iam_binding",
]

_IAC_RULES = [
    ("s3-bucket-public-access", "S3 bucket allows public access", "critical",
     "aws_s3_bucket", "Ensure S3 buckets are not publicly accessible"),
    ("sg-unrestricted-ingress", "Security group allows unrestricted ingress", "high",
     "aws_security_group", "Restrict ingress to specific CIDR ranges"),
    ("iam-admin-policy", "IAM policy with full admin access", "high",
     "aws_iam_policy", "Follow least privilege principle"),
    ("rds-unencrypted", "RDS instance without encryption", "high",
     "aws_rds_instance", "Enable encryption at rest for RDS"),
    ("rds-public-access", "RDS instance publicly accessible", "critical",
     "aws_rds_instance", "Disable public access for RDS instances"),
    ("lambda-no-vpc", "Lambda function not in VPC", "medium",
     "aws_lambda_function", "Place Lambda functions in VPC"),
    ("cloudwatch-no-retention", "CloudWatch log group without retention", "medium",
     "aws_cloudwatch_log_group", "Set retention period for log groups"),
    ("storage-no-https", "Azure storage allows HTTP", "high",
     "azurerm_storage_account", "Enforce HTTPS-only access"),
    ("nsg-any-inbound", "NSG allows any inbound traffic", "high",
     "azurerm_network_security_group", "Restrict NSG inbound rules"),
    ("keyvault-no-purge", "Key Vault without purge protection", "medium",
     "azurerm_key_vault", "Enable purge protection for Key Vault"),
    ("gce-default-sa", "GCE instance uses default service account", "medium",
     "google_compute_instance", "Use dedicated service account"),
    ("gcs-uniform-access", "GCS bucket without uniform access", "medium",
     "google_storage_bucket", "Enable uniform bucket-level access"),
    ("iam-binding-all-users", "IAM binding grants access to allUsers", "critical",
     "google_project_iam_binding", "Remove allUsers from IAM bindings"),
]

_CERTIFICATIONS = [
    "SOC 2 Type II", "ISO 27001", "ISO 27701", "HIPAA BAA",
    "PCI DSS Level 1", "FedRAMP Moderate", "GDPR Compliant",
    "CSA STAR Level 2", "SOC 1 Type II",
]
...
def generate_devices(count: int = 200) -> list[dict]:
    ...
    for i in range(count):
        platform = _RNG.choice(["macOS", "macOS", "macOS", "Windows", "Windows", "Linux", "iOS", "Android"])
...
def generate_endpoints_edr(count: int = 150) -> list[dict]:
    ...
    for _ in range(count):
        ...
        endpoints.append({
            ...
            "status": status,
            "policy_name": _RNG.choice(["Standard Protection", "High Security", "Server Workload", "Developer"]),
            "prevention_mode": prevention_mode,
            "sensor_version": f"6.{_RNG.randint(50, 58)}.{_RNG.randint(0, 9)}",
            "group_name": _RNG.choice(["Production Servers", "Workstations", "Engineering", "Executives"]),
        })
    return endpoints
...
def generate_cloud_instances(count: int = 300) -> list[dict]:
    ...
    for i in range(count):
        ...
        svc_tag = _RNG.choice(["api", "web", "worker", "scheduler", "ml", "database", "cache", "proxy"])
        ...
        instances.append({
            ...
            "security_groups": [f"sg-{_RNG.randbytes(4).hex()}" for _ in range(_RNG.randint(1, 3))],
            "tags": {
                "Environment": env_tag,
                "Service": svc_tag,
...
def generate_iam_policies(count: int = 50) -> list[dict]:
    ...
    policy_names = [
        ...
        "S3FullAccess", "EC2FullAccess", "LambdaExecutionRole",
        "DatabaseAdmin", "BillingViewAccess", "SecurityAudit",
        "CloudWatchReadOnly", "SecretsManagerReadWrite", "ECSTaskExecution",
        "CodeDeployRole", "CICDPipelineRole", "DataScienceNotebook",
        "KMSKeyAdmin", "VPCFlowLogWriter", "GuardDutyReader",
        "SSOPermissionSet-Dev", "SSOPermissionSet-Admin",
        "SSOPermissionSet-ReadOnly", "SSOPermissionSet-Security",
        "CrossAccountAudit", "BackupOperator", "NetworkAdmin",
    ]
    policies = []
    for i in range(count):
        ...
        permissions = ["*"] if has_admin else _RNG.sample(
            ["s3:GetObject", "s3:PutObject", "ec2:DescribeInstances",
             "iam:ListUsers", "logs:GetLogEvents", "lambda:InvokeFunction",
             "secretsmanager:GetSecretValue", "kms:Decrypt", "rds:DescribeDBInstances",
             "dynamodb:Query", "sqs:SendMessage", "sns:Publish"],
            k=_RNG.randint(2, 6),
        )
...
def generate_storage_buckets(count: int = 80) -> list[dict]:
    ...
    """
    purposes = [
        "logs", "backups", "data-lake", "static-assets", "uploads",
        "ml-models", "terraform-state", "artifacts", "reports", "exports",
    ]
    buckets = []
    for i in range(count):
        cloud = _RNG.choice(["aws", "aws", "azure", "gcp"])
        ...
        if cloud == "aws":
            enc = _RNG.choice(["sse-s3", "sse-s3", "sse-kms", "cmk"]) if _RNG.random() > 0.08 else "none"
        elif cloud == "azure":
        ...
        region = _RNG.choice(CLOUD_REGIONS) if cloud == "aws" else (
            _RNG.choice(_AZURE_REGIONS) if cloud == "azure" else _RNG.choice(_GCP_REGIONS)
        )
...
def generate_code_findings(count: int = 200) -> list[dict]:
    ...
    for _ in range(count):
        ...
        ext = {"python": ".py", "typescript": ".ts", "go": ".go", "java": ".java",
               "rust": ".rs", "javascript": ".js", "kotlin": ".kt", "swift": ".swift"}[lang]

        path_parts = _RNG.choice(["src", "lib", "app", "pkg", "internal", "services"])
        filename = _RNG.choice([
            "auth", "api", "handler", "service", "util",
            "controller", "middleware", "db", "config", "routes",
        ])
...
def generate_container_images(count: int = 100) -> list[dict]:
    ...
    for _ in range(count):
        ...
        tag = _RNG.choice(["latest", "v1.0.0", "v1.1.0", "v1.2.3", "v2.0.0-rc1",
                           f"sha-{_RNG.randbytes(3).hex()}", "stable", "canary"])
...
def generate_employees(count: int = 500) -> list[dict]:
    ...
    for i in range(count):
        ...
        if status == "terminated":
            termination_date = (start_date + timedelta(days=_RNG.randint(60, 600))).strftime("%Y-%m-%d")
...
def generate_training_records(count: int = 500) -> list[dict]:
    ...
    for _ in range(count):
        ...
        if status == "completed":
            completed_at = (assigned + timedelta(days=_RNG.randint(1, 14))).strftime("%Y-%m-%dT%H:%M:%S+00:00")
...
def generate_security_alerts(count: int = 300) -> list[dict]:
    ...
    for _ in range(count):
        ...
        if status in ("resolved", "false_positive"):
            resolved_at = (detected + timedelta(hours=_RNG.randint(1, 72))).strftime("%Y-%m-%dT%H:%M:%S+00:00")
...
def generate_incidents(count: int = 30) -> list[dict]:
    ...
    for i in range(count):
        ...
        if status in ("contained", "resolved", "closed"):
            contained_at = (reported + timedelta(hours=_RNG.randint(1, 24))).strftime("%Y-%m-%dT%H:%M:%S+00:00")
        if status in ("resolved", "closed"):
            resolved_at = (reported + timedelta(hours=_RNG.randint(24, 168))).strftime("%Y-%m-%dT%H:%M:%S+00:00")
        ...
        incidents.append({
            ...
            "root_cause": _RNG.choice(root_causes) if status in ("resolved", "closed") else None,
            "lessons_learned": (
...
def generate_policy_documents(count: int = 25) -> list[dict]:
    ...
    for i in range(min(count, len(_POLICY_TITLES))):
        ...
        last_reviewed = (approved + timedelta(days=_RNG.randint(0, 350))).strftime("%Y-%m-%dT%H:%M:%S+00:00")
...
def generate_dns_queries(count: int = 200) -> list[dict]:
    ...
    """
    safe_domains = [
        "google.com", "github.com", "slack.com", "aws.amazon.com",
        "login.microsoftonline.com", "api.stripe.com", "cdn.jsdelivr.net",
        "registry.npmjs.org", "pypi.org", "fonts.googleapis.com",
        "sentry.io", "datadog-agent.com", "okta.com", "zoom.us",
...
def generate_email_events(count: int = 300) -> list[dict]:
    ...
    """
    external_domains = [
        "gmail.com", "outlook.com", "partner-co.com", "vendor-inc.com",
        "newsletter.example.com", "noreply@github.com", "support@stripe.com",
    ]
    subjects_normal = [
        "Q4 Planning Meeting", "Invoice #INV-2026-4391", "Re: Project Update",
        "Weekly Standup Notes", "Action Required: Review PR #342",
        "Your order has shipped", "New comment on JIRA-1234",
        "Security Advisory: Update Required", "Monthly Report - January",
        "Welcome to the team!", "PTO Request Approved",
    ]
    subjects_phishing = [
    ...
    for _ in range(count):
        ...
        if roll < 0.03:
            ...
            # Spam / malware
            from_addr = f"offer@{_RNG.choice(['deals-now.biz', 'promo-blast.info', 'free-stuff.click'])}"
            to_addr = internal_email
            subject = _RNG.choice(["CONGRATULATIONS YOU WON", "Limited time offer!!!", "Free gift card"])
...
def generate_terraform_workspaces(count: int = 30) -> list[dict]:
    ...
    """
    ws_names = [
        "acme-prod-us-east", "acme-prod-eu-west", "acme-staging-us-east",
        "acme-dev-us-east", "acme-prod-networking", "acme-prod-database",
        "acme-prod-kubernetes", "acme-prod-monitoring", "acme-staging-kubernetes",
        "acme-prod-iam", "acme-prod-security", "acme-prod-dns",
        "acme-prod-cdn", "acme-staging-database", "acme-dev-kubernetes",
        "acme-prod-secrets", "acme-prod-logging", "acme-prod-backup",
        "acme-prod-ml-infra", "acme-staging-ml-infra",
        "acme-prod-api-gateway", "acme-prod-lambda", "acme-staging-lambda",
        "acme-prod-data-lake", "acme-dev-sandbox",
        "acme-prod-compliance", "acme-prod-waf", "acme-staging-waf",
        "acme-prod-container-registry", "acme-prod-service-mesh",
    ]
    workspaces = []
    for i in range(count):
...
def generate_iac_misconfigs(count: int = 100) -> list[dict]:
    ...
    for _ in range(count):
        ...
        module = _RNG.choice([
            "modules/networking", "modules/compute", "modules/database",
            "modules/iam", "modules/storage", "modules/monitoring",
