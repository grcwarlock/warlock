...
GRC platforms ingest data from 362 source connectors — vulnerability scanners, identity providers, HRIS systems, audit logs, cloud APIs. Many of these sources include personal data: email addresses, employee names, phone numbers. Before this change, that PII flowed through the pipeline and landed in findings, reports, and exports.
