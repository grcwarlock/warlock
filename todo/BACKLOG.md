...
- [ ] H-12: Scope AI conversation sessions to user (any user can read/delete others') — M | P0
...
- [ ] H-22: GDPR anonymization uses hardcoded HMAC secret (workflows/gdpr.py:62) — S | P0
...
- [ ] H-29: Legacy SHA-256 password hashes accepted with no forced migration — M | P1
- [ ] H-30: Pipeline runs all connectors in one transaction (~59K inserts hold write locks) — L | P1
...
- [ ] H-35: No UniqueConstraint on natural keys for ControlResult and PostureSnapshot — M | P1
- [ ] H-36: AuditEntry.sequence is Integer in migration but BigInteger in model — S | P1
